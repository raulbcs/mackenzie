...
public final class UsuarioUtil {
    ...
    static public int getUniqueUsuarioId(final Connection conn) throws java.sql.SQLException {
        int id;
...
// this constructor is intentionally private
    ...
    static public Connection getConnection() {
        ...
        try {
            ...
            conn = DriverManager.getConnection(UsuarioConstantes.URL, UsuarioConstantes.USER,
    ...
    static public Collection makeUsuarioObjectsFromResultSet(final ResultSet rs) throws java.sql.SQLException {
        Collection<Usuario> result = new java.util.ArrayList();
        while (rs.next()) {
